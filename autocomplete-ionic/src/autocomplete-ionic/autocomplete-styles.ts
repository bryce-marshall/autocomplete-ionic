...
export class AutocompleteStyles {
    ...
    public static getStyleInnerHTML() {
        return sang.getStyleInnerHTML()
            ...
            + ".md .autocomplete-popup { min-width: 90%; --trim-below: 24px; --float-above: 20px; --float-below: 14px; background-color: #fafafa;}\r\n"
            ...
            + "/* iOS Styles */"
            + ".ios .autocomplete-popup { min-width: 90%; --trim-below: 24px; --float-above: 4px; --float-below: 4px; }"
            ...
            + ".wp .autocomplete-popup { min-width: 90%; --trim-below: 24px; --float-above: 5px; --float-below: 5px; }"
